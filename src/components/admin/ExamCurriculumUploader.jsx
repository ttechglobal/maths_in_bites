// src/components/admin/ExamCurriculumUploader.jsx
// ============================================================
// EXAM curriculum upload (WAEC / JAMB / NECO) — ORIGINAL FILE
// Flat JSON array of topics. No terms. Untouched.
// ============================================================
...
const EXAM_GRADES = ['WAEC', 'JAMB', 'NECO', 'GCE', 'BECE', 'IGCSE'];
...
export default function ExamCurriculumUploader() {
  const { data: allPaths, loading: lpLoading } = useLearningPaths();
  // Only show exam learning paths here
  const learningPaths = (allPaths || []).filter(lp =>
    lp.mode === 'exam' || EXAM_GRADES.includes(lp.grade)
  );
